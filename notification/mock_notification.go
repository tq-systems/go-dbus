...
// Source: vgitlab01.tq-net.de/tq-em/libs/dbus.git/notification (interfaces: Client)
...
func (m *MockClient) Send(arg0 Severity, arg1, arg2 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) Send(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) SendServiceLog(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
